...
$title = "Dashboard - SD Muhammadiyah Bojonggede";
...
//menampilkan ranking
$ujian = mysqli_query($koneksi, "SELECT * FROM tbl_ujian WHERE hasil_ujian = 'LULUS' or hasil_ujian = 'GAGAL'");
$rank = mysqli_num_rows($ujian);

$nis = array();
$total = array();
while ($data = mysqli_fetch_array($ujian)) {
    $nis[] = $data['nis'];
