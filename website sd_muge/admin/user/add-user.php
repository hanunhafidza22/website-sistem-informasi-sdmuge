...
$title = "Tambah User - SD Muhammadiyah Bojonggede";
...
if ($msg == 'oversize') {
    $alert = '<div class="alert alert-warning alert-dismissible fade show" role="alert">
    <i class="fa-solid fa-xmark"></i> Tambah User Gagal, Ukuran Gambar lebih dari 1 MB!
    <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
  </div>';
}
...
if ($msg == 'added') {
    ...
    <i class="fa-solid fa-circle-check"></i> Tambah User Berhasil, Segera ubah password Anda!
    <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
  </div>';
}
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-4 text-center px-5">
                                    <img src="../asset/image/person.png" alt="gambar user" class="mb-3" width="40%">
