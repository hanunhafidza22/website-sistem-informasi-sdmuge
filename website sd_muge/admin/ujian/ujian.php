...
$title = "Data Ujian - SD Muhammadiyah Bojonggede";
                                ...
                                <table style="text-align: center" class="table table-hover" id="datatablesSimple">
                                    <thead>
                                        <tr>
                                            ...
                                            <th scope="col"><center>Nama Siswa/i</center></th>
                            ...
                            <div class="modal-body">
                                ...
                                <select name="no" id="no" class="form-select">
                                    ...
                                    while ($data =  mysqli_fetch_array($dataUjian)) { ?>
                                        <option value="<?= $data['no_ujian']?>"><?= $data['no_ujian'] . ' - ' . $data['nis'] . ' - ' . $data['nama']?></option>
                                    <?php
                                    }
                                    ?>
                                </select>
