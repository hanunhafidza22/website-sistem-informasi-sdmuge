...
$title = "Tambah Data Fasilitas Sekolah - SD Muhammadiyah Bojonggede";
...
<div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Tambah Data Fasilitas Sekolah</h1>
                        ...
                        <form action="proses-fasilitas.php" method="POST" enctype="multipart/form-data">


                        <div class="card">
                            <div class="card-header">
                                <span class="h5 my-2"><i class="fa-solid fa-square-plus"></i> Tambah Data Fasilitas Sekolah </span>
